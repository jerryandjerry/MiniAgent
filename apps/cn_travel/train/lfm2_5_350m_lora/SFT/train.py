...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name_or_path", type=str, default=str(BASE_MODELS_DIR / "LFM2.5-350M"), help="Base model to fine-tune")
    parser.add_argument("--output_dir", type=str, default=str(TRAIN_ROOT / "lfm2_5_350m_lora" / "SFT" / "adapter"))
